				...
				<section id="mailList">
					...
					<?php if (empty($_POST)): ?>
						...
						<form id="mailing" method="POST" action="/Midterm/index.php">

							<input type="text" name="name" placeholder="Name" maxlength="60" class="mail">

							<input type="text" name="email" placeholder="Your Email Address" maxlength="60" class="email">
